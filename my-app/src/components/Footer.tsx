                ...
                <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1.3fr] gap-12">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ul className="list-none p-0 m-0 flex flex-col gap-2.5">
                            <li><a href="#how" className="text-muted no-underline text-sm transition-all hover:text-primary hover:translate-x-1 inline-block">How it Works</a></li>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ul className="list-none p-0 m-0 flex flex-col gap-2.5">
                            ...
                            <li><a href="#" className="text-muted no-underline text-sm transition-all hover:text-primary hover:translate-x-1 inline-block">Press Kit</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <ul className="list-none p-0 m-0 flex flex-col gap-2.5">
                            <li><a href="#" className="text-muted no-underline text-sm transition-all hover:text-primary hover:translate-x-1 inline-block">Help Center</a></li>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="mt-2">
                            <p className="text-sm text-muted mb-3 m-0">Get updates on new features</p>
                            <form className="flex gap-2 bg-slate-900/60 border border-slate-700/20 rounded-xl p-1 transition-all focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/10" onSubmit={(e) => e.preventDefault()}>
                                <input type="email" placeholder="Your email" required className="flex-1 bg-transparent border-none outline-none text-text-main text-sm px-3 py-2.5 font-sans placeholder:text-muted/60" />
                                <button type="submit" className="bg-primary border-none rounded-lg w-10 h-10 flex items-center justify-center text-[#0a0a0a] cursor-pointer transition-all hover:scale-105 hover:shadow-lg flex-shrink-0">
